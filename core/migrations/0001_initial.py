# Generated by Django 3.2.3 on 2021-06-11 02:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_desc', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.tipousuario', verbose_name='Integre una breve descripcion de cargos del nuevo usuario:')),
            ],
        ),
        migrations.CreateModel(
            name='Reserva',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('res_hora_reservada', models.CharField(choices=[['08:00', '08:00'], ['09:00', '09:00'], ['10:00', '10:00'], ['11:00', '11:00'], ['12:00', '12:00'], ['13:00', '13:00'], ['14:00', '14:00'], ['15:00', '15:00'], ['16:00', '16:00'], ['17:00', '17:00'], ['18:00', '18:00'], ['19:00', '19:00'], ['20:00', '20:00']], max_length=5, verbose_name='Seleccione hora a reservar:')),
                ...
                ('serv_titulo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.servicio', verbose_name='Ingrese servicio a realizar:')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prod_nombre', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.producto', verbose_name='Ingrese el nombre del Producto entrante')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc_comuna', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.comuna')),
            ],
        ),
        migrations.AddField(
            model_name='ciudad',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc_bol_fac', models.CharField(choices=[['Boleta', 'Boleta'], ['Factura', 'Factura']], max_length=7, verbose_name='Seleccione tipo de pago: ')),
                ('desc_medio_pago', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.tipopago')),
                ('serv_titulo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.servicio')),
            ],
        ),
